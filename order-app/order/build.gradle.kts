...
dependencies {
    ...
    // Infrastructure
//    implementation("com.example.ec:order-infrastructure-cosmos:1.0.0")
//    implementation("com.azure.spring:azure-spring-boot-starter-cosmos:3.9.0")
    implementation("com.example.ec:order-infrastructure-jpa:1.0.0")
...
//    implementation("com.example.ec:eventsourcing-jpa:1.0.0")
